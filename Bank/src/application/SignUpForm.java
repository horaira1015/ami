...
public class SignUpForm implements Initializable{
	...
	public void back() {
		new Main().changeScene("Startscreen.fxml","Start Screen",759,483);
	}
	...
	public void objUpload(Customer c) throws SQLException {
		String query1 = " INSERT INTO `aronotun`.`information` VALUES (NULL,'"+c.getUsername()+"','"+c.getFname()+"','"+c.getMname()+"','"+c.getLname()+"','"+c.getPhoneno()+"','"+c.getEmail()+"','"+c.getDob()+"','"+c.getGender()+"',"+0+");";
		...
		String query2=" INSERT INTO `aronotun`.`login` VALUES (NULL,'"+c.getUsername()+"','"+c.getPassword()+"');";
